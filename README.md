...
| [`operative`](packages/operative/README.md)                 | Provider-agnostic agent loop, sessions, scheduler, durable runs, context assembly, [guardrails](packages/operative/README.md#operativeguardrails--guardrails), retry, streaming, provider factories, and `operative/store` run tracking. |
