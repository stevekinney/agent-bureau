...
| Session                                                               | Independently owned                                        | Asynchronous       | Durable when a session store is composed                                | `sessionId`                                   | Live `SessionHandle`; locator via `Bureau.getSession`/`listSessions`                                                                                                                                                                                                                                                                               | Unchanged by this amendment                                                                                                                                                                                                                          |
...
| Evaluation, direct synchronous invocation (as shipped today)          | Synchronous inline                                         | Synchronous inline | Process-local                                                           | none                                          | Caller holds the batch result directly                                                                                                                                                                                                                                                                                                             | Unchanged                                                                                                                                                                                                                                            |
| Evaluation, asynchronous/background runner (not yet built)            | Independently owned                                        | Asynchronous       | Undecided until it exists                                               | `evaluationRunId`                             | Same handle/locator family as an agent run                                                                                                                                                                                                                                                                                                         | Not yet filed; see [Not decided](#not-decided)                                                                                                                                                                                                       |
