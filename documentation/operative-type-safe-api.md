...
| Heartbeat loop (`createHeartbeat`)                                                    | Independently owned, **detached from launch.** `start()` launches a fire-and-forget asynchronous loop and `stop()` flips a flag and returns without awaiting an in-flight `tick()` or async `onTick`.                                                                                                                                                                                                                                                                                                                | Asynchronous, long-lived                                                                                                                                                                                                                                                                     | Process-local                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | none of its own — individual ticks are scheduler submissions, which does not give the loop an identity                                                                                                                                                                                             | **Declared non-conformance.** The long-lived loop itself has no discovery, no observation, and no awaitable shutdown; classifying its ticks does not cover it.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | **AB-37** owns the awaitable shutdown surface                                                                                                                                                                                                                                                                                                                                                                                                                           |
