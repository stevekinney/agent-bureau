...
| `sessionVerbCapabilities`                                                                                                                       | `{ signal: true; update: false; query: false }`                                                          | Constant, synchronous capability discovery for the three session verbs (AB-192).                                                               |
