...
| `sessionVerbCapabilities`                                                                                                                       | `{ signal: true; update: false; query: false }`                                                          | Constant, synchronous capability discovery for the three throw/no-throw session verbs (AB-192); `submitSessionInput` is a distinct, always-present fourth verb not covered by this map.                                                                                                                                                                                                                                                                               |
