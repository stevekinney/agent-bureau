...
| `createOutputPIIValidator`      | Output validator | Model output                      | Detects PII patterns (email, phone, SSN-shaped, etc.) in generated text.                                                   |
...
| `createCodeSafetyValidator`     | Output validator | Model output                      | Flags dangerous code patterns (shell execution, filesystem writes, network calls) in generated code.                       |
