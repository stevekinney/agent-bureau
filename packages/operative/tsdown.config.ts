...
const entry = {
  ...
  'providers/batches/index': './src/providers/batches/index.ts',
  'providers/batches/anthropic': './src/providers/batches/anthropic.ts',
  'providers/batches/openai': './src/providers/batches/openai.ts',
  'providers/batches/gemini': './src/providers/batches/gemini.ts',
