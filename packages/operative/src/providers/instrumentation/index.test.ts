/**
 * `instrumentGenerate` backend-descriptor propagation (AB-64, AB-245, AB-288).
...
import { instrumentGenerate } from './index';
...
describe('instrumentGenerate — backend-descriptor propagation', () => {
  it("preserves the wrapped function's attached descriptors on the returned wrapper", async () => {
    ...
    const wrapped = instrumentGenerate(generate, {
      provider: 'anthropic',
