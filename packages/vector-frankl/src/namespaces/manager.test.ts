...
describe('NamespaceManager', () => {
  ...
  describe('createNamespace', () => {
    ...
    it('should initialize the namespace database', async () => {
      ...
      expect(namespace.addVector('test-1', vector, { test: true })).resolves.toBeUndefined();
  ...
  describe('getNamespace', () => {
    ...
    it('should throw for non-existent namespace', async () => {
      expect(manager.getNamespace('does-not-exist')).rejects.toThrow(NamespaceNotFoundError);
    });
  });
  ...
  describe('deleteNamespace', () => {
    ...
    it('should throw for non-existent namespace', async () => {
      expect(manager.deleteNamespace('does-not-exist')).rejects.toThrow(NamespaceNotFoundError);
    });
  });
