...
import type { NamespaceConfig } from '@/core/types.ts';
...
describe('VectorNamespace', () => {
  ...
  describe('vector operations', () => {
    ...
    it('should enforce dimension constraints', async () => {
      ...
      expect(namespace.addVector('wrong', wrongVector)).rejects.toThrow(DimensionMismatchError);
    });
  ...
  describe('storage estimation', () => {
    ...
    it('should scale with dimension', async () => {
      const largeNamespace = new VectorNamespace('large', { dimension: 1024 }, 'test-root');
