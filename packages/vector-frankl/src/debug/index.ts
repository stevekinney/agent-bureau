...
// Core debug system
import { createDebugConsole } from './console.ts';
import { DebugContext } from './debug-context.ts';
import { DebugManager, debugManager } from './debug-manager.ts';
import { NestedProfiler, Profiler, profiler } from './profiler.ts';
