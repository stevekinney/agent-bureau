...
import { debugManager } from './debug-manager.ts';
import type { MemoryUsage, PerformanceStats, ProfileEntry } from './types.ts';
...
export class Profiler {
  ...
  mark(profileId: string, markName: string): void {
    ...
    entry.marks.set(markName, this.timeSource.highResolutionNowMilliseconds() - entry.startTime);
  }
