      ...
      if (typeof WebAssembly !== 'undefined' && WebAssembly.validate) {
        ...
        try {
          const simdTest = new Uint8Array([
            ...
            0x7b, 0x03, 0x02, 0x01, 0x00, 0x0a, 0x07, 0x01, 0x05, 0x00, 0xfd, 0x0f, 0x0b,
          ]);
        ...
        try {
          const bulkTest = new Uint8Array([
            ...
            0x03, 0x02, 0x01, 0x00, 0x05, 0x03, 0x01, 0x00, 0x00, 0x0a, 0x09, 0x01, 0x07, 0x00,
            0x41, 0x00, 0x41, 0x00, 0x41, 0x00, 0xfc, 0x08, 0x0b,
          ]);
