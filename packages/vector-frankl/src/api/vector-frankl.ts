import { NamespaceExistsError } from '@/core/errors.ts';
import type {
  BatchOptions,
  NamespaceConfig,
  NamespaceInfo,
...
import { NamespaceManager } from '@/namespaces/manager.ts';
import { VectorNamespace } from '@/namespaces/namespace.ts';

import { VectorDB } from './database.ts';
