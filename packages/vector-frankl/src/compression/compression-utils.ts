 ...
 */
export function quantizeValue(value: number, min: number, max: number, bits: number): number {
 ...
 */
export function dequantizeValue(quantized: number, min: number, max: number, bits: number): number {
 ...
 */
export function calculateOptimalBits(vector: Float32Array, targetPrecisionLoss: number): number {
 ...
 */
export function packQuantizedValues(values: number[], bits: number, buffer: ArrayBuffer): void {
