...
import type { CompressedVector, CompressionConfig } from './base-compressor.ts';
import type { CompressionRecommendation } from './compression-manager.ts';
