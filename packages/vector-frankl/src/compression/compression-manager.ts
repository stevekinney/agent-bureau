...
import type { CompressionStrategy } from '@/core/types.ts';
...
import { calculateVectorStatistics, type VectorStatistics } from './compression-utils.ts';
import { ProductQuantizer } from './product-quantizer.ts';
import { ScalarQuantizer } from './scalar-quantizer.ts';
