 ...
 */
export type VectorFormat = Float32Array | Float64Array | Int8Array | Uint8Array | number[];
 ...
 * Distance metrics
 */
export type DistanceMetric = 'cosine' | 'euclidean' | 'manhattan' | 'hamming' | 'jaccard' | 'dot';
