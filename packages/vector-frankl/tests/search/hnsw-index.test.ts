...
import type { VectorData } from '@/core/types.ts';
import { HNSWIndex } from '@/search/hnsw-index.ts';
...
describe('HNSWIndex', () => {
  describe('exportState / importState round-trip', () => {
    ...
    it('should preserve metadata through export/import', async () => {
      ...
      await index.addVector(makeVector('with-meta', [1, 2, 3], { category: 'test', count: 42 }));
