  ...
  test('should work across all browsers', async ({ page, browserName }) => {
    ...
    await page.evaluate(async (browser) => {
      try {
        ...
        window.addTestResult(`${browser} Compatibility`, 'error', (error as Error).message);
        throw error;
      }
    }, browserName);
  ...
  test('should handle browser-specific storage limits', async ({ page, browserName }) => {
    ...
    await page.evaluate(async (browser) => {
      try {
        ...
        window.addTestResult(`${browser} Storage Limits`, 'error', (error as Error).message);
        throw error;
      }
    }, browserName);
  ...
  test('should handle browser-specific API differences', async ({ page, browserName }) => {
    ...
    await page.evaluate(async (browser) => {
      try {
        ...
        window.addTestResult(`${browser} API Compatibility`, 'error', (error as Error).message);
        throw error;
      }
    }, browserName);
