...
import type { VectorData } from '../../src/core/types.ts';
import { GPUSearchEngine } from '../../src/gpu/gpu-search-engine.ts';
...
describe('GPUSearchEngine', () => {
  ...
  describe('GPU Search Operations', () => {
    ...
    it('should support different distance metrics', async () => {
      ...
      // Test dot product
      const { results: dotResults } = await engine.search(testVectors, queryVector, 1, 'dot');
