...
import { InputValidator } from '@/core/input-validator.ts';
...
describe('InputValidator', () => {
  ...
  describe('validateDimension', () => {
    ...
    test('throws when the value is not an integer', () => {
      ...
      expect(() => InputValidator.validateDimension(384.5)).toThrow('Dimension must be an integer');
    });
  ...
  describe('validateK', () => {
    ...
    test('throws when the value is not an integer', () => {
      expect(() => InputValidator.validateK(5.5)).toThrow('Search parameter k must be an integer');
    });
  ...
  describe('validateMetadata', () => {
    ...
    test('throws when metadata is a primitive', () => {
      expect(() => InputValidator.validateMetadata('string')).toThrow('Metadata must be an object');
    ...
    test('respects a custom maxObjectProperties option', () => {
      ...
      expect(() => InputValidator.validateMetadata(metadata, { maxObjectProperties: 2 })).toThrow(
        'Metadata cannot have more than 2 properties',
      );
    });
    ...
    describe('nested object validation', () => {
      ...
      test('respects a custom maxObjectDepth option', () => {
        ...
        expect(() => InputValidator.validateMetadata(metadata, { maxObjectDepth: 2 })).toThrow(
          'Metadata object depth cannot exceed 2',
        );
      });
    });
    ...
    describe('array value validation', () => {
      ...
      test('validates individual elements within an array', () => {
        expect(() => InputValidator.validateMetadata({ items: [1, 'text', () => {}] })).toThrow(
          'Invalid metadata value type: function',
        );
      });
    });
  ...
  describe('validateVectorIds', () => {
    ...
    test('throws when the argument is not an array', () => {
      ...
      expect(() => InputValidator.validateVectorIds(null)).toThrow('Vector IDs must be an array');
