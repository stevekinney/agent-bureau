...
import type { DatabaseConfig } from '@/core/types.ts';
...
describe('VectorDatabase', () => {
  ...
  describe('transactions', () => {
    ...
    test('should create a read transaction', async () => {
      const transaction = await database.transaction(VectorDatabase.STORES.VECTORS, 'readonly');
    ...
    test('should create a write transaction', async () => {
      const transaction = await database.transaction(VectorDatabase.STORES.VECTORS, 'readwrite');
